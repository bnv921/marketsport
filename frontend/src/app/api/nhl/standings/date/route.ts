...
// NHL API endpoint для получения таблицы по дате
...
export async function GET(request: NextRequest) {
  try {
    ...
    const nhlApiUrl = `https://api-web.nhle.com/v1/standings/${date}`;
    ...
    console.error("[NHL API] Error fetching standings by date:", error);
    return NextResponse.json(
