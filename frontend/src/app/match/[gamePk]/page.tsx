...
export default function MatchPage() {
  ...
  // Формирование eventSlug для Polymarket с использованием UTC
          ...
          <div className="rounded-lg border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-6">
            ...
            {polymarketMarket ? (
              <>
                ...
                {polymarketMarket && (polymarketMarket.awayProbability !== undefined || polymarketMarket.homeProbability !== undefined) && (
                  <div className="mb-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="border border-zinc-200 dark:border-zinc-800 rounded-lg p-4">
                      ...
                      {polymarketMarket.awayPrice !== undefined ? (
                        ...
                        <div className="w-full bg-zinc-100 dark:bg-zinc-800 text-zinc-500 dark:text-zinc-400 text-sm font-medium py-2 px-4 rounded text-center">
                          Цена недоступна
                        </div>
                      )}
                    </div>
            ...
            ) : !polymarketLoading && !polymarketError && !polymarketMarket ? (
              <div className="text-sm text-zinc-500 dark:text-zinc-400">
            ...
            {polymarketMarket?.tokenId && (
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
                <OrderBook tokenId={polymarketMarket.tokenId} />
                <TradeForm tokenId={polymarketMarket.tokenId} />
              </div>
            )}
          </div>
        )}
